...
def generate_chart_1():
    ...
    p = figure(x_range=list(df.columns[1:]), plot_height=500, title="UHSx 65ww by Treatment Function Time Series", x_axis_label="Month", y_axis_label="Number of Patients")
